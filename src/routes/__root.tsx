...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    head: () => ({
      meta: [{ name: "google-adsense-account", content: "ca-pub-4544341360469168" },
        { charSet: "utf-8" },
      ...
      scripts: [
        {
          async: true,
          src: "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4544341360469168",
          crossOrigin: "anonymous",
        },
        {
          ...
          children: JSON.stringify({
            ...
            slogan:
              "Web, digital and IT solutions for businesses and individuals.",
            description:
