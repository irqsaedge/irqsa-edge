  ...
  return (
    <Reveal className="card-rim rounded-3xl border border-border bg-card p-7 shadow-card sm:p-9">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        Share a few details and your email app will open with the enquiry already prepared.
      </p>
      ...
      <form onSubmit={handleSubmit} className="mt-7 grid gap-5">
        ...
        <p className="text-center text-xs text-muted-foreground">
          Your enquiry is prepared for both IRQSA Edge email addresses. Click Send in your email app to deliver it. Available 24/7.
        </p>
      </form>
    </Reveal>
  );
